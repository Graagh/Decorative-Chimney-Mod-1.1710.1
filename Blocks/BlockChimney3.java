...
import com.DecorativeChimney.Items.ItemChimney3;
...
public class BlockChimney3 extends Block implements ITileEntityProvider
{
	private final String name ="blockChimney3";
	private int maxMeta = 16;

	public BlockChimney3(Class class1)
	{
		super(Material.rock);
    	setHardness(5.0F);
    	setResistance(1.0F);
    ...
    public ArrayList<ItemStack> getBlockDropped(World world, int x, int y, int z, int metadata, int fortune)
    {
        ...
        if ((metadata & 8) == 0)
        {
            ItemStack itemstack = new ItemStack(DecorativeChimneyCore.itemChimney3, 1, this.getDamageValue(world, x, y, z));
            TileEntityChimney3 tileEntityChimney3 = (TileEntityChimney3)world.getTileEntity(x, y, z);
    ...
    {
        return DecorativeChimneyCore.itemChimney3;
    }
