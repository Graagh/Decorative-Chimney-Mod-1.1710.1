...
import com.DecorativeChimney.Items.ItemChimney2;
...
public class BlockChimney2 extends Block implements ITileEntityProvider
{
	private final String name ="blockChimney2";
	private int maxMeta = 16;

	public BlockChimney2(Class class1)
	{
		super(Material.rock);
    	setHardness(5.0F);
    	setResistance(1.0F);
    ...
    public void registerIcons(IIconRegister iconRegister)
    {
    	...
    	{
    		ItemStack blockChimneyBricksStack = new ItemStack(DecorativeChimneyCore.blockChimney2, 64, i);
    ...
    public ArrayList<ItemStack> getBlockDropped(World world, int x, int y, int z, int metadata, int fortune)
    {
        ...
        if ((metadata & 8) == 0)
        {
            ItemStack itemstack = new ItemStack(DecorativeChimneyCore.itemChimney2, 1, this.getDamageValue(world, x, y, z));
            TileEntityChimney2 tileEntityChimney2 = (TileEntityChimney2)world.getTileEntity(x, y, z);
    ...
    {
        return DecorativeChimneyCore.itemChimney2;
    }
